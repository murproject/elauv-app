...
export function parseOptions(options) {
  ...
  return {
    /* Fixed here: compatibility with ES6 */
    allowEmptyBackpackOpen:
        options.allowEmptyBackpackOpen ? options.allowEmptyBackpackOpen : defaults.allowEmptyBackpackOpen,
    useFilledBackpackImage:
        options.useFilledBackpackImage ? options.useFilledBackpackImage : defaults.useFilledBackpackImage,
    contextMenu: {
